-- Complete reset of menu data for actual database structure
...
-- อาหารจานเดียวแนะนำ
INSERT INTO menu_items (name, price, category_id, is_available, is_recommended) VALUES
('ข้าวกระเพราสูตรพริกแห้งโบราณ (หมูกรอบ)', 50, 1, true, true),
('ข้าวกระเพราสูตรพริกแห้งโบราณ (ทะเล)', 60, 1, true, true),
('ข้าวกระเพราสูตรพริกแห้งโบราณ (หมู)', 50, 1, true, true),
('ข้าวกระเพราสูตรพริกแห้งโบราณ (เนื้อ)', 50, 1, true, true),
('ข้าวกระเพราสูตรพริกแห้งโบราณ (ไก่)', 50, 1, true, true),
('ข้าวผัดโบราณ', 50, 1, true, true),
('ข้าวหมึกผัดไข่เค็ม', 60, 1, true, true);
